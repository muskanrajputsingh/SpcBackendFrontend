...
const levels = [
 ...
 const validateForm = () => {
    ...
    if (!formData.level.trim()) {
      newErrors.level = "Description is required"
    } else if (formData.level.trim().length < 10) {
      newErrors.level = "Description must be at least 10 characters"
    }

    if (!formData.level) {
      newErrors.level = "Category is required"
    }
