...
const ViewProduct = () => {
  ...
  useEffect(() => {
  fetchDataFromApi("/users/all-associates")
    .then((res) => {
      if (res?.associates) {
  ...
  if (filterCategory === "all") {
    ...
    const handleEditSubmit = (e) => {
      ...
      const updatedData = { 
        ...editFormData, 
        ratings: ratingValue,
        referralPercentage: parseInt(editFormData.referralPercentage) || 0,
            ...
            <div className="modal-body">
              <div className="detail-section">
                ...
                <div className="detail-item full-width">
                  ...
                  {associates.find(a => a.id === selectedProduct.referralBy)?.name || "N/A"}
                </div>

                 <div className="detail-item full-width">
                <strong> ReferralPercent:</strong> {selectedProduct.referralPercentage ? selectedProduct.referralPercentage + "%" : "N/A"}
                </div>
              </div>
