...
const handleAssociateChange = (e) => {
    ...
    const selectedAssociate = associates.find((a) => a.userId === selectedId);
    setFormData((prev) => ({
      ...prev,
      referralBy: selectedId,
      referralPercent: selectedAssociate?.percent || 0,
    }));
  };
            ...
            <div className="form-group">
              ...
              >
                ...
                {associates.map((assoc) => (
                  <option key={assoc.userId} value={assoc.userId}>
                    {assoc.user?.name || "Associate"} ({assoc.level})
                  </option>
                ))}
              </select>
            </div>
